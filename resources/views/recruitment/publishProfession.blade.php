    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <dd>
                    <form action="/profession/publish" method="post" id="jobForm">
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td width="85">职位类别</td>
                                <td>
                                    <input type="hidden" id="positionType" value="" name="categoryId">
                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                                <ul class="reset job_main">
                                                    ...
                                                    <li>
                                                        <span>{{$categoriesZ[$i]['name']}}</span>
                                                        <ul class="reset job_sub dn">
                                                            @foreach($categoryArrs[$i] as $arr)
                                                            <li>{{$arr['name']}}</li>
                                                            @endforeach
                                                        </ul>
                                                    </li>
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="salary_range">
                                        <div>
                                            <input type="text" placeholder="最低月薪" value="" id="salaryMin" name="salaryLow">
                                            {{--<span>k</span>--}}
                                        </div>
                                        <div>
                                            <input type="text" placeholder="最高月薪" value="" id="salaryMax" name="salaryHigh">
                                            {{--<span>k</span>--}}
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>工作城市</td>
                                <td>
                                    <input type="text" placeholder="请输入工作城市，如：北京" value="" name="city" id="workAddress">
                                </td>
                            </tr>
                            </tbody></table>
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <textarea name="desc" rows="4" cols="50" placeholder="请在此处进行职位描述..." ></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="redstar">*</span></td>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    接收简历邮箱（仅一个）：
                                    <input type="text" value="" id="forwardEmail" name="email">

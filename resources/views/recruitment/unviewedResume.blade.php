    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <h1>
                    <em></em>
                    待处理简历 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber">{{count($resumes)}}</i>个）</span>
                </h1>
                </dt>
                <dd>
                        ...
                        @foreach($resumes as $resume)
                            <ul class="reset my_jobs">
                                <li data-id="149594">
                                    ...
                                    <div class="links">
                                        <a class="job_offline" href="/resume/view/{{$resume['id']}}/{{$resume['profession_id']}}">简历通过</a>

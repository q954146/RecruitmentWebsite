    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <h1>
                    <em></em>
                    已下线职位 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber">{{count($professions)}}</i>个）</span>
                </h1>
                </dt>
                <dd>
                            ...
                            <ul class="reset my_jobs">
                                <li data-id="149594">
                                    ...
                                    <div class="links">
                                        ...
                                        <a class="job_offline" href="/onLineProfession/{{$profession['id']}}">上线</a>

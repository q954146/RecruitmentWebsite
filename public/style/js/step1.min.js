...
$(function () {
    ...
    window.onbeforeunload = function () {
    ...
    }), b = {expires: 1}, null == $.cookie("viewTimes") ? ($("#stepTip img").attr("src", "/style/images/index1.jpg").parent("#stepTip").fadeIn(200), $.cookie("viewTimes", "1", b)) : (c = parseInt($.cookie("viewTimes")) + 1, $("#stepTip img").attr("src","/style/images/index1.jpg").parent("#stepTip").fadeIn(200), $.cookie("viewTimes", c, b)), $(document).click(function () {
        var a = [];
        ...
        submitHandler: function (b) {
            ...
            a = !0, c = $("#companyId").val(), d = $("#companyName").val(),p=$("#tel").val(), e = $("#name").val(), f =img_url, g = $("#website").val(), "http://" != g.substring(0, 7) && (g = "http://" + g), h = $("#city").val(), i = $("#select_industry_hidden").val(), j = $("#select_scale_hidden").val(), k = $("#s_radio_hidden").val(), l = "", l += "[", $("#stagesList > li").each(function (a) {
            ...
            $(b).find(":submit").attr("disabled", !0), $.ajax({
                ...
                url:"/register/company/info"
            }).done(function (a) {
                // console.info(a)
                a.flag==true ? window.location.href = "/register/company/tag" : $("#beError").text(a.msg).show(), $(b).find(":submit").attr("disabled", !1)
            })
        }
